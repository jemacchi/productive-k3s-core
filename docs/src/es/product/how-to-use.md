...
```bash
curl -fsSL https://github.com/jemacchi/productive-k3s/releases/download/vX.Y.Z/install-productive-k3s.sh | bash -s -- preflight
```

Si querés que también fallen los warnings, usá:

```bash
curl -fsSL https://github.com/jemacchi/productive-k3s/releases/download/vX.Y.Z/install-productive-k3s.sh | bash -s -- preflight --strict
```
...
```bash
curl -fsSL https://github.com/jemacchi/productive-k3s/releases/download/vX.Y.Z/install-productive-k3s.sh | bash -s -- bootstrap --dry-run
```
...
```bash
curl -fsSL https://github.com/jemacchi/productive-k3s/releases/download/vX.Y.Z/install-productive-k3s.sh | bash -s -- bootstrap
```
